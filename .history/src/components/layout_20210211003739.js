...
import CloudFlareIcon from "!svg-react-loader!../utils/icons/cloudflare.svg?name=CloudFlareIcon";
...
import TypescriptIcon from "!svg-react-loader!../utils/icons/typescript-icon.svg?name=TypescriptIcon";
import ApolloIcon from "!svg-react-loader!../utils/icons/apollo.svg?name=ApolloIcon";
...
const Layout = props => {
  ...
  const items = [
    ...
    { name: "apollo", url: "https://www.apollographql.com/", comp: ApolloIcon },
    ...
    { name: "cloudflare", url: "https://www.cloudflare.com", comp: CloudFlareIcon }
  ]
  const styles = {
    box: {
      display: "flex",
          ...
          <nav id="swup" class="site-head-left">
            <ul className="nav" role="menu">
              <li className="nav-home" role="menuitem">
                <Link to={`/`} activeClassName="site-head-left-active">Home</Link>
              </li>
